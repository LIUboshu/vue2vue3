...
// const About = () => import('../pages/About.vue');// 路由懒加载 第一种方式
// import Home from "../pages/Home.vue";
const Home = () => import('../pages/Home.vue');// 路由懒加载
// import News from '../pages/News.vue';
const News = () => import('../pages/News.vue');// 路由懒加载
// import Message from '../pages/Message.vue'
const Message = () => import('../pages/Message.vue');// 路由懒加载
// import Detail from '../pages/Detail.vue'
const Detail = () => import('../pages/Detail.vue');// 路由懒加载
// 创间路由
